...
class AudioData:
    ...
    audio_ids: Dict[str, Dict[str, str | int]] = field(default_factory=dict) # ids with their transcription and expiration time
    audio_raw: str = ""
    ...
    def merge(self, 
        ...
        current_audio_raw = base64.b64decode(self.audio_raw) if len(self.audio_raw) else b""
        other_audio_raw = base64.b64decode(other.audio_raw) if len(other.audio_raw) else b""
...
def base64_to_temp_audio_file(
    ...
    try:
        ...
        raise RuntimeError(f"Failed to create temporary audio file: {str(e)}")
